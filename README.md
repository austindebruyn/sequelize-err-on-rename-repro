...
== 20170928040013-create-user: migrating =======
== 20170928040013-create-user: migrated (0.016s)

== 20170928040207-remove-email-column: migrating =======
Unhandled rejection SequelizeDatabaseError: Table 'sequelize_err_on_rename_repro.users' doesn't exist
...
== 20170928040207-remove-email-column: migrated (0.022s)
```
